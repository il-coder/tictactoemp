...
function online()   //function to implement online multiplayer
{
    ...
    url = "wss://free3.piesocket.com/v3/" + scnt +"?apiKey=NxcDNyx8dSmaMAVSGc0jLCXSYXBEwxdmRBIdZUnuannYKQKhyXRIseij7wvO";
...
function host()     //function to allow to generate code and connect using it
{
    ...
    document.getElementById('overlay').style.display="block";
    log.innerHTML = "<p>Match Started</p>";
    url = "wss://free3.piesocket.com/v3/" + code_channel +"?apiKey=NxcDNyx8dSmaMAVSGc0jLCXSYXBEwxdmRBIdZUnuannYKQKhyXRIseij7wvO";
    socket = new WebSocket(url);
    message();
    socket.onopen = function(){
        clearTimeout(to1);
